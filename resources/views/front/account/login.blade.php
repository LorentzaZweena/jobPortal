                ...
                <div class="card shadow border-0 p-5">
                    ...
                    <form action="{{ route('account.authenticate') }}" method="post">
                        ...
                        <button class="btn btn-danger mt-2">Login</button>
                            <a href="forgot-password.html" class="mt-3 text-danger">Forgot Password?</a>
                        </div>
                    </form>                    
                </div>
                <div class="mt-4 text-center">
                    <p>Do not have an account? <a  href="{{ route('account.register') }}" class="text-danger">Register</a></p>
                </div>
            </div>
        </div>
